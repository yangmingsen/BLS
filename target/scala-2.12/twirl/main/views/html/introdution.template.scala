...
"""),_display_(/*5.2*/main("详细信息")/*5.14*/{_display_(Seq[Any](format.raw/*5.15*/("""
    ...
    <div class="listMain">
        ...
        <script type="text/javascript">
                $(function() """),format.raw/*49.30*/("""{"""),format.raw/*49.31*/("""}"""),format.raw/*49.32*/(""");
                $(window).load(function() """),format.raw/*50.43*/("""{"""),format.raw/*50.44*/("""
                    """),format.raw/*51.21*/("""$('.flexslider').flexslider("""),format.raw/*51.49*/("""{"""),format.raw/*51.50*/("""
                        """),format.raw/*52.25*/("""animation: "slide",
                        start: function(slider) """),format.raw/*53.49*/("""{"""),format.raw/*53.50*/("""
                            """),format.raw/*54.29*/("""$('body').removeClass('loading');
        ...
        <div class="item-inform">
            <div class="clearfixLeft" id="clearcontent">
                ...
                <div class="box">
                    <script type="text/javascript">
                            $(document).ready(function() """),format.raw/*84.58*/("""{"""),format.raw/*84.59*/("""
                                """),format.raw/*85.33*/("""$(".jqzoom").imagezoom();
                                $("#thumblist li a").click(function() """),format.raw/*86.71*/("""{"""),format.raw/*86.72*/("""
                                    """),format.raw/*87.37*/("""$(this).parents("li").addClass("tb-selected").siblings().removeClass("tb-selected");
                                    $(".jqzoom").attr('src', $(this).find("img").attr("mid"));
                                    $(".jqzoom").attr('rel', $(this).find("img").attr("big"));
                                """),format.raw/*90.33*/("""}"""),format.raw/*90.34*/(""");
                            """),format.raw/*91.29*/("""}"""),format.raw/*91.30*/(""");
                    </script>

                    <div class="tb-booth tb-pic tb-s310">
                        <a href="/assets/images/01.jpg"><img src="/assets/images/01_mid.jpg" alt="细节展示放大镜特效" rel="/assets/images/01.jpg" class="jqzoom" /></a>
                    </div>
            ...
            <div class="clearfixRight">
                ...
                <div class="tb-detail-hd">
                    <h1>
                        """),_display_(/*125.26*/book/*125.30*/.title),format.raw/*125.36*/("""
                    """),format.raw/*126.21*/("""</h1>
                </div>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Fri Feb 02 11:26:22 CST 2018
                  SOURCE: /home/yms/seed/app/views/introdution.scala.html
                  HASH: 696edf242aa08ca2534bf33ebdc59c864b62038b
                  MATRIX: 752->1|897->51|927->56|947->68|985->69|1017->75|3100->2130|3129->2131|3158->2132|3231->2177|3260->2178|3309->2199|3365->2227|3394->2228|3447->2253|3543->2321|3572->2322|3629->2351|3715->2409|3744->2410|3793->2431|3822->2432|3869->2451|3898->2452|4821->3347|4850->3348|4911->3381|5035->3477|5064->3478|5129->3515|5464->3822|5493->3823|5552->3854|5581->3855|7166->5412|7180->5416|7208->5422|7258->5443
                  LINES: 21->1|26->1|30->5|30->5|30->5|32->7|74->49|74->49|74->49|75->50|75->50|76->51|76->51|76->51|77->52|78->53|78->53|79->54|80->55|80->55|81->56|81->56|82->57|82->57|109->84|109->84|110->85|111->86|111->86|112->87|115->90|115->90|116->91|116->91|150->125|150->125|150->125|151->126
                  -- GENERATED --
              */
